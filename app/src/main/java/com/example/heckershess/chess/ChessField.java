...
import com.example.heckershess.chess.Pieces.Bishop;
import com.example.heckershess.chess.Pieces.King;
import com.example.heckershess.chess.Pieces.Knight;
import com.example.heckershess.chess.Pieces.Pawn;
import com.example.heckershess.chess.Pieces.Piece;
import com.example.heckershess.chess.Pieces.Queen;
import com.example.heckershess.chess.Pieces.Rook;
...
public class ChessField extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chess_field);
        ...
        TextView menu_label_TV = findViewById(R.id.menu_label);
        menu_label_TV.setText(R.string.chess);

        ImageButton rules = findViewById(R.id.rulers);

        rules.setOnClickListener(view -> {
            new AlertDialog.Builder(ChessField.this)
        ...
        //TODO: сделать чтобы таймер запускался с начала хода игрока

        // Получаем ссылку на TextView
        textView = findViewById(R.id.timeChessTV);
        ...
        back_refresh.setOnClickListener(view -> {
            ...
            Button backChessFieldBtn = findViewById(R.id.backChessFieldBtn);
            backChessFieldBtn.setOnClickListener(view1 -> {
                finish();
            });
        });

        Button backChessFieldBtn = findViewById(R.id.backChessFieldBtn);
        backChessFieldBtn.setOnClickListener(view -> {
            finish();
        });
        ...
        if (!AnythingSelected) {
            if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() == null) {
                ...
                if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                    ...
                    Drawable background = DisplayBoardBackground[clickedPosition.getX()][clickedPosition.getY()].getBackground();
                    if (background instanceof ColorDrawable) {
                        int currentColor = ((ColorDrawable) background).getColor();
                        if (currentColor == ContextCompat.getColor(this, R.color.colorBoardDark)) {
                            DisplayBoardBackground[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.color.colorSelectedDark);
                        } else if (currentColor == ContextCompat.getColor(this, R.color.colorBoardLight)) {
                            DisplayBoardBackground[clickedPosition.getX()][clickedPosition.getY()].setBackgroundResource(R.color.colorSelectedLight);
                        }
                    }
...
//                int expectedColor = ContextCompat.getColor(this, R.color.my_color);
                Drawable background = DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].getBackground();
                if (background instanceof ColorDrawable) {
                    int currentColor = ((ColorDrawable) background).getColor();
                    if (currentColor == ContextCompat.getColor(this, R.color.colorBoardDark)) {
                        DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.colorPositionAvailableDark);
                    } else if (currentColor == ContextCompat.getColor(this, R.color.colorBoardLight)) {
                        DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.colorPositionAvailableLight);
                    }
                }
...
//                DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.colorPositionAvailable);
                ...
                if (background instanceof ColorDrawable) {
                    int currentColor = ((ColorDrawable) background).getColor();
                    if (currentColor == ContextCompat.getColor(this, R.color.colorBoardDark)) {
                        DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.colorDangerDark);
                    } else if (currentColor == ContextCompat.getColor(this, R.color.colorBoardLight)) {
                        DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.colorDangerLight);
                    }
                }
